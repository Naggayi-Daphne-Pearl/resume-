      ...
      >
        ...
        />
            ...
            <div className="flex items-center justify-center sm:justify-start">
              <p class="font-header text-xl font-semibold uppercase text-grey-20 text-white ">
                Connect with me
              </p>
              <div class="hidden sm:block">
                <FaAngleRight class="bx bx-chevron-right text-3xl text-yellow" />
              </div>
            </div>
            <div className="flex items-center justify-center pt-5 pl-2 sm:justify-start sm:pt-0">
              <a href="https://github.com/Naggayi-Daphne-Pearl">
                <FaGithub class="bx bxl-github text-2xl text-white hover:text-yellow" />
              </a>
